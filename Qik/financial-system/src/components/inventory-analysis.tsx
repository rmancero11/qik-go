...
export function InventoryAnalysis() {
  ...
  // Datos de ejemplo basados en la tabla 'insumos' y 'perdidas' del diagrama ER
  const inventoryData = [
    {
      id: 1,
      name: "Café en grano",
        ...
        <TabsContent value="inventory" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Listado de insumos y su estado actual</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="losses" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detalle de pérdidas registradas en el período</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                ...
                <TableBody>
                  {lossesData.map((loss) => (
                    <TableRow key={loss.id}>
                      ...
                      <TableCell>${loss.amount.toFixed(2)}</TableCell>
        ...
        <TabsContent value="analytics" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Distribución de pérdidas por categoría de insumo</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Distribución de pérdidas según motivo</CardDescription>
              </CardHeader>
              <CardContent className="flex justify-center">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Evolución del nivel de stock en los últimos meses</CardDescription>
            </CardHeader>
